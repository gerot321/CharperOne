...
import com.example.gerrys.charperone.Model.User;
...
public class ConfirmationAccCourDetail extends AppCompatActivity {
    private StorageReference fileRef;
    FirebaseDatabase database;
    FirebaseStorage storage;
    DatabaseReference docReq,addUser,prodReq,prod,merchant;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cour_detail);
        ...
        prodReq = database.getReference("ReqAccCourier");
        addUser = database.getReference("User");
                ...
                try {
                    ...
                    fileRef.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            progressDialog.dismiss();
                            Toast.makeText(ConfirmationAccCourDetail.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
        ...
        ConfirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                User user = new User(prodss.getName().toString(),prodss.getPass().toString(),"kurir", "0",prodss.getAddress().toString(),prodss.getGender().toString(),"-", "-", "-",prodss.getImage().toString(),prodss.getEmail().toString());
                addUser.child(prodss.getPhone().toString()).setValue(user);
                Toast.makeText(ConfirmationAccCourDetail.this, "Account Approved", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
